...
class IEMOCAP_6_Class(Dataset):
    def __init__(self, args, dataset_path, pass_unknown=True, split='train', cv_fold=0, up_sampling=False):
        self.args = args
        self.bottleneck_len = args.bottleneck_len
        self.label_type = args.label_type
        self.base_path = os.path.join(args.dataset_root_dir, args.dataset_name) 
    ...
    def __getitem__(self, index):
        return_dict = {}
        emotion_mapping = IEMOCAP_EMOTION_MAPPING
        ...
        return_dict['pixel_values'] = vision_inputs.pixel_values.squeeze()
        return_dict["image_path"] = sample['image_path']
