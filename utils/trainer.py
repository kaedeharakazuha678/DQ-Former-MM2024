...
class CustomTrainer(Trainer):
    def __init__(self, *args, **kwargs):
        ...
        self.additional_losses: List[str] = []
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> torch.Tensor:
        ...
        # Save additional losses
        self.additional_losses.append(output_dict["return_dict"])
    ...
    def log(self, logs: Dict[str, float]) -> None:
        ...
        for i, additional_loss in enumerate(self.additional_losses):
            for loss_name, loss_value in additional_loss.items():
                logs[f"{loss_name}"] = loss_value
